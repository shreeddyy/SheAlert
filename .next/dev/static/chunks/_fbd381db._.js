...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setServerError('');
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])('/api/auth/signup', {
                method: 'POST',
                body: JSON.stringify({
                    name: formData.name,
...
_s(SignupPage, "EFU2MnRpsDafQ0T9dF5QbrsA1Lc=", false, function() {
    return [
...
//# sourceMappingURL=_fbd381db._.js.map