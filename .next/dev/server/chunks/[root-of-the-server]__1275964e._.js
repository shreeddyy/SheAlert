...
"[project]/app/api/journey/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Please sign in to view journeys."
        }, {
            status: 401
        });
    }
    ...
    const journeys = db.journeys.filter((item)=>item.userId === user.id).sort((a, b)=>new Date(b.startedAt).getTime() - new Date(a.startedAt).getTime()).map((journey)=>({
            ...journey,
            guardianNames: contacts.filter((contact)=>journey.guardianContactIds.includes(contact.id)).map((contact)=>contact.name)
        }));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        journeys,
        contacts
...
async function POST(request) {
    ...
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Please sign in to start Journey Mode."
        }, {
            status: 401
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1275964e._.js.map