...
function SignupPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setServerError('');
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRequest"])('/api/auth/signup', {
                method: 'POST',
                body: JSON.stringify({
                    name: formData.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__629d461a._.js.map