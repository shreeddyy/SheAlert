...
"[project]/app/api/safety-plan/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Please sign in to view your safety plan."
        }, {
            status: 401
        });
    }
...
async function PUT(request) {
    ...
    if (!user) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Please sign in to update your safety plan."
        }, {
            status: 401
        });
    }
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeDb"])((state)=>({
            ...state,
            safetyPlans: current ? state.safetyPlans.map((item)=>item.userId === user.id ? safetyPlan : item) : [
                ...state.safetyPlans,
                safetyPlan
            ]
        }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cb4f083e._.js.map